        ...
        <div className="card">
          <div className="card-body">
            ...
            <form action="POST">
              ...
              <section>
                <div className="form-group row">
                  ...
                  <div className="col-sm-9 mt-3">
                    <input type="text" className="form-control" id="userAge" />
                  </div>
                  ...
                  <label htmlFor="userWeight" className="col-sm-3 col-form-lable mt-3">Weight:</label>
                  <div className="col-sm-9 mt-3">
                    <input type="text" className="form-control" id="userWeight" />
                  </div>
                  <label htmlFor="userHeight" className="col-sm-3 col-form-lable mt-3">Height:</label>
                  <div className="col-sm-9 mt-3">
                    <input type="text" className="form-control" id="userHeight" />
                  </div>
                </div>
              </section>
              <section>
              ...
              <section>
                <div className="form-group row">
                  <label htmlFor="userAge" className="col-sm-3 col-form-lable mt-3">Duration:</label>
                  <div className="col-sm-9 mt-3">
                    <input type="text" className="form-control" id="userAge" />
                  </div>
                  <label htmlFor="userAge" className="col-sm-3 col-form-lable mt-3">Date:</label>
                  <div className="col-sm-9 mt-3">
